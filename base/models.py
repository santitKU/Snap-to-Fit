...
# class SleepTable(models.Model):
#     deepSleepTime = models.IntegerField(blank=False, null=False)
#     shallowSleepTime = models.IntegerField(blank=False, null=False)
#     wakeTime = models.IntegerField(blank=False, null=False)
...
class DailyVitals(models.Model):
    ...
    # sleeptime = models.OneToOneField(SleepTable, on_delete=CASCADE)
